					...
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
						...
						<li class="nav-item">
							<a href="?page=data-kegiatan" class="nav-link">
								<i class="nav-icon far fa fa-award"></i>
								<p>
									Data Kegiatan
								</p>
							</a>
						...
						<li class="nav-item">
							<a href="?page=data-kegiatan" class="nav-link">
								<i class="nav-icon far fa fa-angrycreative"></i>
								<p>
									Data Kegiatan
								</p>
							</a>
    ...
    ?>
		...
		<footer class="main-footer">
			<div class="float-right d-none d-sm-block">
				Copyright &copy;
				<a target="_blank" href="https://www.instagram.com/ppkmhdi/">
					<strong> Kesatuan Mahasiswa Hindu Dharma Indonesia (KMHDI)</strong>
				</a>
				All rights reserved.
			</div>
			<b>Created 2022</b>
